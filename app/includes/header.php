...
<header>
    <div class="header-logo">
        <a href="./index.php"><img src=<?php //  echo BASEHTML_PATH."public/images/other/icons/web-logo.png" ?>
    ...
    <div class="header-content">
        ...
        <div class="header-content-menu">
            <a href=<?php // echo BASEHTML_PATH ?>>Inicio</a>
    ...
    <div class="header-userinfo">
        ...
        <a id="header-userinfo-cart" href="#cart"><img src=<?php // echo BASEHTML_PATH."public/images/other/icons/user-cart.png"?> alt="Cart" /></a>
    </div>
</header>
 -->
